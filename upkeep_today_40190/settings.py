"""
Django settings for upkeep_today_40190 project.
...
ROOT_URLCONF = 'upkeep_today_40190.urls'
...
WSGI_APPLICATION = 'upkeep_today_40190.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "upkeep_today_40190 API",
    "DESCRIPTION": "API documentation for upkeep_today_40190 App",
    "VERSION": "v1",
}
